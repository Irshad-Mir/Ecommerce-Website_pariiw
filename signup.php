      ...
      <div class="container">
        <div class="row no-gutters">
          <div class="col-md-8 col-lg-7 col-xl-6 offset-md-2 offset-lg-2 offset-xl-3 u-space-3 u-space-0--lg">
            <!-- Form -->
            <form class="js-validate mt-5" action="signup_process.php" method="post">
              <!-- Title -->
              <div class="mb-7">
                <h1 class="h3 text-primary font-weight-normal mb-0">Welcome to <span class="font-weight-bold">Pariiw</span></h1>
              ...
              <div class="js-form-message mb-4">
                  <!--Input-->
                   <label class="h6 small d-block text-uppercase">User Name</label>
          ...
          <!-- --<div class="js-form-message mb-3">
           ...
           --->
              ...
              <div class="js-form-message mb-5">
                <div class="custom-control custom-checkbox d-flex align-items-center text-muted">
                  ...
                  <label class="custom-control-label" for="termsCheckbox">
                    <small>
                      I agree to the
                      <a class="u-link-muted" href="../pages/terms.html">Terms and Conditions</a>
                    </small>
                  </label>
                </div>
              </div>
              ...
              <!-- End Button -->
              <p class="mt-5 mb-3 text-muted">&copy; 2018 Pariiw Pvt Ltd. All Rights Reserved.</p>
            </form>
            <!-- End Form -->
          </div>
        </div>
