...
<body>
  ...
  <!-- ========== MAIN ========== -->
  <main id="content" role="main" class="bg-dark">
    <!-- Form -->
      ...
      <div class="container">
        <div class="row no-gutters">
          <div class="col-md-8 col-lg-7 col-xl-6 offset-md-2 offset-lg-2 offset-xl-3 u-space-3 u-space-0--lg">
            <!-- Form -->
            <form class="js-validate mt-5" method="post" action="admin_verify.php">
                
                <!-- Title -->
              <div class="mb-7">
                <h2 class="h3 text-primary font-weight-normal mb-0">Welcome <span class="font-weight-bold">Administrator</span></h2>
