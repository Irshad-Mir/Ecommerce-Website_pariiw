...
$mail->Body    = "Hey, <b> {$row['name']} </b> Please use this password to login <b>  {$row['password']}</b>";
...
if(!$mail->send()) {
 ...
 echo "<span> Kindly check your mail for your password. Thanks! </span>";
}
        ...
        <nav class="js-mega-menu navbar navbar-expand-md u-header__navbar">
          ...
          <div id="navBar" class="collapse navbar-collapse py-0">
            ...
            <ul class="navbar-nav u-header__navbar-nav ml-lg-auto">
             ...
             <!-- Order List -->
             <li class="nav-item hs-has-mega-sub-menu u-header__nav-item"
                ...
                <a id="homeMegaMenu" class="nav-link u-header__nav-link pl-0" href="https://pariiw.com"
...
<!-- ========== New Main Content 06/01/2019 ========== -->
  <main id="content" role="main">
    <!-- Hero v1 Section -->
     <div class="u-hero-v1 u-space-3 container-fluid">
      <center>
      
       
   <form class="form-signin" method="POST" action="forgot_password.php">
        <h2 class="h4 form-signin-heading">Forgot Password</h2>
        <div class="input-group col-md-3">
	  <span class="input-group-addon" id="basic-addon1"></span>
	  <input type="text" name="email" class="form-control" placeholder="Enter your email id " required>
	</div>
	<br />
        <button class="btn btn-lg btn-primary btn-sm" type="submit">Forgot Password</button>
        <a class="btn btn-lg btn-success btn-sm" href="signin.php">Sign-in>></a>
      </form>
    </center>
    </main>
