...
?>
    ...
    <input type="reset" title="*Reset your changes" value="cancel" class="btn btn-default btn-sm">
		<input type="submit" title="*Change above content then press Modify!" name="save_change" value="Modify" class="btn btn-primary btn-sm">
		<a href="admin_book.php" title="*Confirm your changes" class="btn btn-success btn-sm">Confirm</a>
	</form>
