...
<table class="table-bordered text-center table-striped" >
<tr>
 <th>Book Isbn</th>
<th>Quantity</th>
<th>OrderId</th>
...
$sql="select * from orders,order_items WHERE orders.orderid=order_items.orderid";
...
<tr>
    ...
    <td ><input type="radio" value="shipped" name="status" value="Not Shipped" >Pending<br>
    <input type="radio" value="shipped" name="status" value=" Shipped" >Shipped
    </td>
</tr>
...
function change() 
{
    ...
    if (elem.value=="Shipped") elem.value = "Not Shipped";
    else elem.value = "Shipped";
}
</script>
	<?php }  ?>
    </table>
...
<div class="container text-center u-space-1">
      <!-- Logo -->
      <a class="d-inline-block mb-2" aria-label="Front" href="index.php">
